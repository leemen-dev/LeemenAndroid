...
//            }
    ...
    public boolean onFragmentCreate() {
        ...
        if (searchString == null) {
            ...
            observersGroup.add(NotificationCenter.secondSpaceModeChanged);
            if (!onlySelect) {
...
//            }
    ...
    private boolean openAccountSelector(View view) {
        ...
        for (int a = 0; a < UserConfig.MAX_ACCOUNT_COUNT; a++) {
            if (UserConfig.getInstance(a).isClientActivated() && !SecondSpaceController.isHiddenFromSelectedAccount(a)) {
