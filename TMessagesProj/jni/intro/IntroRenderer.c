...
JNIEXPORT void Java_org_telegram_messenger_Intro_onSurfaceCreated(JNIEnv *env, jclass class) {
    ...
    // The (6,-5) anchor was tuned for the asymmetric Telegram paper plane; the Leemen
    // "L" texture is centered in its canvas, so a non-zero anchor pushes it off-center.
